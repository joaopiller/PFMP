...
const posts = [
    ...
    },
    {
        ...
        date: "12/06/2025",
        authors: "Flávia Perim e Pedro Marchesi",
        description: "A integração de critérios ambientais, sociais e de governança nas estratégias empresariais tornou-se fundamental para a sustentabilidade dos negócios.",
        image: esg,
        paragraphs: [
            "A adoção de práticas ESG (Environmental, Social and Governance) transformou-se em elemento essencial para a competitividade empresarial, influenciando decisões de investimento e determinando a reputação corporativa no mercado contemporâneo.",
            "A Lei nº 14.133/2021, que estabelece normas gerais de licitações e contratos administrativos, incorporou critérios de sustentabilidade que exigem das empresas fornecedoras do poder público o cumprimento de padrões ambientais e sociais rigorosos.",
            "Os programas de compliance devem integrar elementos de sustentabilidade e responsabilidade social, criando mecanismos de monitoramento e controle que assegurem o cumprimento de compromissos ESG assumidos pelas organizações perante stakeholders e investidores.",
            "A transparência corporativa assume papel fundamental neste contexto, exigindo que as empresas publiquem relatórios detalhados sobre suas práticas de sustentabilidade, impactos socioambientais e estruturas de governança, conforme diretrizes internacionais reconhecidas.",
            "Investidores institucionais têm priorizado empresas com sólidas práticas ESG, criando incentivos econômicos para a adoção de modelos de negócio sustentáveis e socialmente responsáveis, o que impacta diretamente a valorização das companhias no mercado de capitais.",
            "A regulamentação ESG continua evoluindo no Brasil, com expectativa de maior rigor nas exigências de disclosure e na implementação de políticas de sustentabilidade, tornando essencial o acompanhamento jurídico especializado nesta área emergente do direito empresarial."
        ]
    }
]
